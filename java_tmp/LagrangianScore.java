...
public class LagrangianScore {
    ...
    private static String szMath = "-linkmode launch -linkname \"c:/program files/wolfram research/mathematica/10.0/mathkernel.exe\"";     
    private static String szScript = "C:\\Users\\User\\Desktop\\Goliath\\Goliath\\nb\\LagrangeSolver.m";
   ...
   //escape characters etc...!
    ...
    private static void OpenLink() throws MathLinkException{
         ml = MathLinkFactory.createKernelLink(szMath);   
         ml.discardAnswer();
    }
    ...
    private static String exeCmdString(String cmd) throws MathLinkException{
        ml.evaluate(cmd);
        ml.waitForAnswer();
        return (ml.getString());
    }
...
///////////////////////////////////////////////////////////////
    ...
    public static void InitFunctions() throws MathLinkException{
      OpenLink();
    exeCmd("Get[\"C:/Users/User/Desktop/Goliath/Goliath/nb/LagrangeSolver.m\"]");
     exeCmd("data = PrepareData[\"c:/Users/User/Desktop/mma_double.csv\", 0.1];");
